...
class EventHandler:
    ...
    def handle_mouse_press(self, event: QtGui.QMouseEvent):
        ...
        if self.viewer.current_tool in ['brush', 'eraser', 'paint', 'restore'] and self.viewer.hasPhoto():
            if self._is_on_image(scene_pos):
    ...
    def handle_mouse_move(self, event: QtGui.QMouseEvent):
        ...
        if self.viewer.current_tool in ['brush', 'eraser', 'paint', 'restore'] and self.viewer.drawing_manager.current_path:
            if self._is_on_image(scene_pos):
    ...
    def handle_mouse_release(self, event: QtGui.QMouseEvent):
        ...
        if self.viewer.current_tool in ['brush', 'eraser', 'paint', 'restore']:
